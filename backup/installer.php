...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230820_ktelecom_f2ae4ccfacb05f8e5395_20230820190515_archive.zip';
        const ARCHIVE_SIZE       = '29865628';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f2ae4cc-20190515';
        const SECONDARY_PACKAGE_HASH = '9d3a178-20190515';
